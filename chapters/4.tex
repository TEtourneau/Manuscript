...
Nous décrivons dans cette section comment ajuster ces paramètres afin d'obtenir les bons $b_{\mathrm{Ly}\alpha}$, $\beta_{\mathrm{Ly}\alpha}$, $\overline F(z)$ et $P^{1D}(k, z)$. Nous nous servons des données décrites dans la section~\ref{prov} comme référence pour les paramètres du \lya{}.
