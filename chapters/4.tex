...
\textbf{Concernant le champ d'absorption \lya{}, les RSD sont prises en compte par une modification de la formule FGPA (voir la fin de l'appendice~\ref{app:fgpa}).
  Pour ce faire, nous avons besoin du gradient de vitesse $\eta_{\parallel}$ à $z=0$.
...
\end{equation}
où $\eta$ est le gradient sans dimension de la vitesse $v_p$ le long de la ligne de visée, et $x_p$ est la coordonnée comobile le long de cette ligne de visée.
...
\textbf{Ceci nous permet, lorsque nous sommons le gradient $\eta$ et le contraste $\delta$ (voir appendice~\ref{app:fgpa}), de retrouver la formule de Kaiser :}
\begin{align}
  \label{eq:kaiser5}
...
\textbf{Nous pouvons noter ici une importante amélioration par rapport aux mocks développés pour BOSS : ces mocks disposaient de lignes de visée parallèles \autocite{LeGoff2011}, ou alors ne disposaient pas de corrélation croisée \lya{}$\times$QSO \autocite{Font-Ribera2012}. Les mocks présentés dans ce manuscrit disposent à la fois de lignes de visée non parallèles et d'une corrélation croisée \lya{}$\times$QSO.}
