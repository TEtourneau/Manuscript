...
\paragraph{}
\textbf{Les premières détections des oscillations acoustiques de baryon ont été faites à la fin des années~90. Ces observations ont été menées à l'aide de ballons volant en haute atmosphère (voir notamment les expériences \emph{BOOMERanG} \autocite{Masi2002} et \emph{MAXIMA} \autocite{Hanany2000}).
...
\textbf{Il n'est donc pas possible de mener une analyse RSD uniquement avec le \lya{}, car il n'est pas possible de déduire le taux de croissance $f$ des paramètres $b_{\mathrm{Ly}\alpha}$ et $\beta_{\mathrm{Ly}\alpha}$.
...
% De plus, du fait des vitesses importantes du gaz présent dans ces objets effondrés, le profile d'absorption des HCD est élargi, produisant une absorption au delà de la position physique de l'absorbeur.
\textbf{De plus, du fait de leur très grande densité, le profile d'absorption des HCD est très élargi\footnote{A l'inverse, l'élargissement des profiles d'absorption du \lya{} est dominé par l'élargissement thermique.}, produisant une absorption au delà de la position physique de l'absorbeur. }
...
Ces HCD sont tellement denses qu'ils peuvent être identifiés dans les spectres. Dans l'analyse~\cite{DuMasdesBourboux2020}, les DLA identifiés sont modélisés par un profile de Voigt, puis, tous les pixels pour lesquels la fraction de flux transmis est inférieure à \num{0.80} sont masqués, les autres sont corrigés grâce au profile de Voigt.
