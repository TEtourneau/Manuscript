...
\textbf{Plus tard, le satelitte COBE fut envoyé dans l'espace afin de détecter les anisotropies du CMB. Selon les prédictions des modèles de big bang, le spectre du CMB suit une loi de corps noir, avec une température d'environ $3\,\mathrm{K}$, et possède des anisotropies correspondant aux perturbations primordiales de densité. La mission fut un succès et les résultats ont été annoncés en 1992 : le spectre du CMB est mesuré avec une température $T=2,73 \pm 0,06\,\mathrm{K}$, ne déviant pas du spectre du corps noir de plus de $0,25\,\mathrm{\%}$ \cite{CITE:https://www.ncbi.nlm.nih.gov/pmc/articles/PMC46596/}. D'autre part, les mesures de COBE ont permis d'identifier les perturbations primordiales de densité, source des structures à grande échelle que l'on observe aujourd'hui. Ce dernier élément constitue un des arguments les plus solides en faveur des modèles de big bang.}
