...
\textbf{Nous pouvons remarquer dans ce tableau que, comme pour les mocks eboss-0.0, la mesure des paramètres \lya{} dans la corrélation croisée \lya{}$\times$QSO n'est pas compatible avec la mesure faite sur l'auto-corrélation \lya{}$\times$\lya{}.
...
Ceci est investigué dans le chapitre suivant.}
