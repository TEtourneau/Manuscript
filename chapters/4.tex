...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{p1d_smoothing}
...
Dans notre cas, le spectre de puissance à trois dimensions $P(\kpar{}, \kperp{})$ à intégrer est le spectre de puissance de la matière $P_{\mathrm{matière}}(\kpar{}, \kperp{})$ multiplié par $G^2(\kpar{}, \kperp{})W^2(\kpar{}, \kperp{})$. Contrairement au cas à trois dimensions, l'effet de la taille des voxels et du lissage gaussien est important pour le spectre de puissance à une dimension.
En effet, le spectre de puissance le long d'une ligne de visée est beaucoup plus sensible aux petites échelles (grands $k$), 
Ces deux effets sont représentés sur la figure~\ref{prov}
