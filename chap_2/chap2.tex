...
% Afin de construire le relevé eBOSS, le même algorythme a été utilisé pour sélectionner les quasars. Cette fois ci, la présence d'un échantillon de quasars à $0.9 < z < 2.2$ destiné à la fois à la mesure de l'échelle BAO et du clustering (\#prov) a permis réduire les critères de sélection des QSO et ainsi de dégrader l'homogénéïté de l'échantillon de quasars Ly$\alpha$ afin d'augmenter le nombre de cibles. 
...
\begin{figure}
  \centering
  \includegraphics[scale=0.3]{images/CcdSchema}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{images/Filtres}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.35]{images/CartoucheImage}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{images/SchemaSpectro}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{images/SpectroThroughput}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{images/SpectroResoPower}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.3]{images/DesiVsEboss}
