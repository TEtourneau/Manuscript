...
\begin{figure}
  ...
  \caption{Mesure de $H(z) / (1+z)$ à l'aide des BAO. Les points roses (\cite{Beutler2011}), noirs (\cite{Ross2014a}) et verts (\cite{Alam2016}) présentent les mesures faites avec des galaxies. Le point rouge donne la mesure faite avec l'auto-corrélation du \lya{}(\cite{CITE}) et le point bleu la mesure faite avec la corrélation croisée \lya{}-QSO (\cite{CITE}). La ligne noire montre la valeur donnée par la cosmologie de Planck (\cite{planck_collaboration_planck_2015}). Crédits : \cite{CITE}}
  \label{fig:h_vs_z}
\end{figure}
...
\begin{figure}
  ...
  \caption{Image radio du quasar 3C 175 prise avec le VLA. Les deux jets ultra-relativistes visibles ont une taille d'environ \SI{212}{\perh\kpc}. Crédits : \cite{Bridle1994}}
  \label{fig:qso_jets}
\end{figure}
...
\begin{figure}
  ...
  \caption{Spectre d'un quasar eBOSS à haut rapport signal sur bruit. Le quasar se trouve à un redshift $z=3.058$.
    ...
    Les lignes continues donnent le continu $C_{q}(\lambda_{RF})$ en supposant $\bar F(z)$ mesuré par \cite{Calura2012}, pour la forêt \lya{} et \lyb{}. L'identifiant du quasar est $\mathrm{Thing\_id} = 498518806$.
