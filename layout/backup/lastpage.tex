...
\newcommand{\PhDTitleFR}{Etude de l'énergie noire avec les forêts \lya{} d'eBOSS}													%% Titre de la thèse en français / Thesis title in french
...
\newcommand{\PhDTitleEN}{Study of dark energy using \lya{} forest from eBOSS}													%% Titre de la thèse en anglais / Thesis title in english
