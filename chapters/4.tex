...
Concernant le champ d'absorption \lya{}, les RSD sont prises en compte par une modification de la formule FGPA (voir la fin de l'appendice~\ref{app:fgpa}).
...
Ceci nous permet, lorsque nous sommons le gradient $\eta$ et le contraste $\delta$ (voir appendice~\ref{app:fgpa}), de retrouver la formule de Kaiser :
\begin{align}
  \label{eq:kaiser5}
...
Nous pouvons noter ici une importante amélioration par rapport aux mocks développés pour BOSS : ces mocks disposaient de lignes de visée parallèles \autocite{LeGoff2011}, ou alors ne disposaient pas de corrélation croisée \lya{}$\times$QSO \autocite{Font-Ribera2012}. Les mocks présentés dans ce manuscrit disposent à la fois de lignes de visée non parallèles et d'une corrélation croisée \lya{}$\times$QSO.
