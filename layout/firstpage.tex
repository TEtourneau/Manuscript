...
\newcommand{\ecodoctitle}{Particules, Hadrons, Énergie, Noyau, Instrumentation, Imagerie, Cosmos et Simulation (PHENIICS)} 			%% Nom de l'ED. Voir site de l'Université Paris-Saclay / Full name of Doctoral School. See Université Paris-Saclay website
...
\newcommand{\defensedate}{31 septembre 2020} 															%% Date de soutenance / Date of defense
...
%\newcommand{\logoEt}{etab} 																%% Logo de l'université partenaire. Placer le fichier .png dans le répertoire '/etab' et indiquer le nom du fichier sans l'extension / Logo of partner university. Place the .png file in the directory '/etab' and point the file name without the extension
...
\newcommand{\jurynameA}{Reza Ansari}
\newcommand{\juryadressA}{Professeur, Universit\'e Paris-Sud}
\newcommand{\juryroleA}{Président}

%%% Membre n°2 (Rapporteur) / Member n°2 (Reviewer)
\newcommand{\jurynameB}{Delphine Hardin}
\newcommand{\juryadressB}{Madame, Universit\'e Paris VI}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Matthew Pieri}
\newcommand{\juryadressC}{Monsieur, Universit\'e Aix-Marseille}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Andreu Font-Ribera}
\newcommand{\juryadressD}{Monsieur, University College London}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Jean-Marc Le Goff}
\newcommand{\juryadressE}{Monsieur, CEA Saclay}
