...
\paragraph{}
Grâce à l'étude approfondie de nos simulations (voir les chapitres~\ref{chap:mock_ana} et~\ref{chap:data_ana}), nous montrons que l'analyse des données finales d'eBOSS DR16, présentée dans \textcite{DuMasdesBourboux2020}, produit une mesure des paramètres BAO $\apar{}$ et $\aperp{}$ non baisée à \SI{1}{\percent} près.
