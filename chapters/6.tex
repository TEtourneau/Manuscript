...
- nous reproduisons l'analyse des mocks eboss-0.2 avec Rogers avec Lhcd=2.8 : meme chose que C-G mask –> les deux mesures sont equivalentes (et equivalente avec C-G no mask) donc c'est validé
- nous reproduisons l'analyse de DR16 avec Lhcd=2.8 : meme chose que pour C-G mask, donc ca c'est OK, mais par contre ca donne pas la meme chose que C-G no mask : probleme qqpart dans les donnees
