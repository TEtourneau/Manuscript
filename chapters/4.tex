...
\begin{figure}
  ...
  \caption{Fraction de flux transmise moyenne $\overline F$ en fonction du redshift mesurée dans les mocks. La ligne en pointillés (orange) montre la paramétrisation définie dans l'équation~\ref{eq:mean_trans}.}
