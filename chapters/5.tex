...
Le modèle produit de \texttt{picca} décrit très bien les raw mocks.
% \begin{figure}
%   \centering
%   \includegraphics[scale=0.4]{cf_eboss00_4bins}
%   \caption{L'auto-corrélation \lya{}$\times$\lya{} calculée sur les raw mocks. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle produit par \texttt{picca}.}
%   \label{fig:cf_eboss00_4bins}
% \end{figure}
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{cf_ebossraw_4bins_pred}
  \caption{L'auto-corrélation \lya{}$\times$\lya{} calculée sur la moyenne des \Nmocks{} raw mocks. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
...
Enfin, pour chacun des jeux des données montrés sur la figure~\ref{fig:bias_pred}, nous ajustons une loi de puissance du type $a (1+z)^{\gamma}$.
...
% Nous présentons maintenant la même analyse que précédemment, mais en considérant cette fois ci les cent fonctions de corrélation croisée \lya{}$\times$QSO calculées sur les raw mocks. La figure~\ref{prov} (\#prov faire la figure) montre la moyenne de ces cent fonctions de corrélation croisées. La fonction de corrélation est montrée dans quatre bins en redshift. La ligne continue (couleur) donne l'ajustement du modèle produit par \texttt{picca}. La prédiction est montrée en (couleur).
% \#prov conclusion
...
Pour chacun de ces bins, nous estimons la corrélation de dix réalisations des raw mocks, puis nous calculons et ajustons la moyenne de ces dix fonctions de corrélation. La figure~\ref{fig:auto_qso_4bins} montre la moyenne des dix fonctions de corrélation et leur modèle ajusté dans chaque bin en redshift. Pour chacun des bins, la fonction de corrélation est montrée dans trois bins en $\mu$. 
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{auto_qso_4bins}
  \caption{L'auto-corrélation QSO$\times$QSO calculée sur les mocks. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bin en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans trois bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
...
La figure~\ref{fig:bias_auto_qso} montre $b_{\textsc{QSO}}$ et $\beta_{\textsc{QSO}}$ obtenus avec l'ajustement de la moyenne des dix fonctions de corrélation.
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{cf_eboss00_4bins}
  \caption{L'auto-corrélation \lya{}$\times$\lya{} calculée sur les mocks eboss-0.0. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
  \label{fig:cf_eboss00_4bins}
\end{figure}
...
\begin{figure}
  ...
  \caption{La corrélation croisée \lya{}$\times$QSO calculée sur les mocks eboss-0.0. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
...
\begin{figure}
  ...
  \caption{L'auto-corrélation \lya{}$\times$\lya{} calculée sur les mocks eboss-0.2. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
...
\subsubsection{La corrélation croisée \lya{}$\times$QSO}
La figure~\ref{fig:xcf_eboss02_4bins} présente la mesure de la corrélation croisée \lya{}$\times$QSO. Celle ci est estimée sur \Nmocks{} réalisations eboss-0.2 et dans quatre bins en redshift. Pour chacun des bins en redshift, la fonction de corrélation est montrée dans quatre bins en $\mu$.
Les lignes continues donnent le meilleur ajustement du modèle produit par \texttt{picca}.
...
\begin{figure}
  ...
  \caption{La corrélation croisée \lya{}$\times$QSO calculée sur les mocks eboss-0.2. Chaque graphique donne la moyenne des fonctions de corrélation calculées dans chaque bins en redshift pour chaque réalisation. Les fonctions de corrélation sont montrées dans quatre bins en $\mu$. Les lignes continues donnent le meilleur ajustement du modèle.}
