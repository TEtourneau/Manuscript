...
et $\Delta z_{\mathrm{v}}$ et le redshift induit par la vitesse particulière $v_{\parallel}$ du traceur le long de la ligne de visée (effet Doppler). Pour les faibles redshifts ($z << 1$), celui-ci s'exprime comme :
\begin{equation}
  \label{eq:delta_z}
