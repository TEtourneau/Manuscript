...
La mesure de la position du pic BAO s'est ensuite poursuivie à des redshifts intermédiaires à l'aide des galaxies distantes et des forêts $\mathrm{Lyman-}\alpha$ (voir la description de ce traceur dans la section~\ref{subsec:lya}), grâce au projet SDSS. Le chapitre suivant présente ce projet, ainsi qu'une revue des différentes mesures de la position du pic BAO (voir notamment la figure~\ref{fig:exp_hist} qui résume les mesures les plus récentes).
...
Du fait que le contraste du \lya{} est défini en fonction de l'absorption observée (moins il y a de lumière, plus il y a de matière), le biais $b_{\mathrm{Ly}\alpha}$ qui relie $\delta_{\mathrm{Ly}\alpha}$ à $\delta_{\mathrm{matière}}$ est négatif.
