...
La matière baryonique peut être vue comme un gaz de galaxies, qui n'intéragissent entre elles que via la gravitation.
...
\#prov : mettre un petit paragraphe pour décrire le spectre de puissance du CMB : je dis que c'est présenté dans cette section, mais ca l'est pas actuellement
...
$G$ est appelé le facteur de croissance des structures, et varie comme $\mathrm{G}(z) \propto (1+z)^{-1}$ à grand $z$, lorsque $\Omega_m = 1$. Ainsi, pour $z < z_{eq}$, le spectre de puissance varie comme
\begin{equation}
